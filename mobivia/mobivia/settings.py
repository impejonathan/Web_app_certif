"""
Django settings for mobivia project.
...
ALLOWED_HOSTS = ["*","https://carter-cash-django.francecentral.azurecontainer.io"]

# ALLOWED_HOSTS = ["*"] # "localhost","0.0.0.0","*"

# CSRF_COOKIE_SECURE = True
# SESSION_COOKIE_SECURE = True
# CSRF_TRUSTED_ORIGINS = ['https://livretest.azurewebsites.net']  # <-- ici mettre le lien de l'app
...
WSGI_APPLICATION = 'mobivia.wsgi.application'
